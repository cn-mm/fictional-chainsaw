...
class ProgressBar(object):
	"""Simple progress bar.
	Output example: 100.00% [2152/2152]
	"""
...
def DownloadMode(urls_file, missing_urls_file, downloads_dir, request_parallelism, timestamp_exactness):
	...
	urls_valid_todownload = urls_full[:2500]
...
def main():
	...
	urls_file_to_download = "./dataset/web_arxive_urls.txt"
	missing_urls_file = "./dataset/web_arxive_urls.missing.txt" 
	downloads_dir = "./dataset/xsum-raw-downloads"
	try:
