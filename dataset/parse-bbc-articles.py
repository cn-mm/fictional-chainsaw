...
if __name__ == "__main__":
    download_dir = "./dataset/xsum-raw-downloads"
    web_arxive_urls_ids = "./dataset/web_arxive_urls_ids.txt"
    result_dir = "./dataset/xsum-extracts-from-downloads"
    try:
        print('Creating the result directory.')
        os.mkdir(result_dir)
    except WindowsError:
	    print('Result directory already exists.')
    failed_id_file = open("./dataset/web_arxive_extracts_failed.txt", "w")
