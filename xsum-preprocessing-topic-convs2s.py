...
if __name__ == '__main__':
  ...
  parser.add_argument('--tok_dir', type=str, default="./xsum-preprocessed", help= "bbs tokenised stories directory")
  parser.add_argument('--out_dir', type=str, default="./data-topic-convs2s", help = "finished files directory")
  parser.add_argument('--split_dict', type=str, default="new_split.json")
  parser.add_argument('--lda_word_topics', type=str, default="./lda-train-document-lemma-topic-512-iter-1000/word_term_topics.log")
